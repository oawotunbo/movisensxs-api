...
public interface XSService {
    ...
    Call<MonitoringRequest> sendMonitoring(@Path("studyId") Integer studyId, @Body MonitoringRequest monitoringRequest)
            throws MovisensXSException;

    @GET("studies/{studyId}/monitoring")
    Call<MonitoringResponse> getMonitoring(@Path("studyId") Integer studyId)
            throws MovisensXSException;

    @GET("studies/{studyId}/monitoring/proband/{probandId}")
    Call<MonitoringPerProbandResponse> getMonitoringPerProband(@Path("studyId") Integer studyId,
